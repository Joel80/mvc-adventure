...
class AdventureDataSetterTest extends TestCase
{
    /**
    ...
    public function testCreateAdventureDataObject()
    {
        ...
        $this->assertInstanceOf("\App\Adventure\AdventureDataSetter", $adventureDataSetter);
    }

    /**
     * Test setting of data with AdventureDataSetter
     */
    public function testAdventureDataSetterSetData()
    {
        $room = new Room("none", "none", "none", "none");
